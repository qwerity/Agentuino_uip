...
SNMP_API_STAT_CODES
AgentuinoClass::begin(char *getCommName, char *setCommName, uint16_t port = SNMP_DEFAULT_PORT)
{
    // set community name set/get sizes
...
SNMP_API_STAT_CODES 
AgentuinoClass::responsePdu(SNMP_PDU *pdu)
{
    int32_u u;
    byte i;
    //
...
void 
AgentuinoClass::onPduReceive(onPduReceiveCallback pduReceived)
{
